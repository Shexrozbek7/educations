    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birthday', models.CharField(default='', max_length=50, null=True)),
                ...
                ('inps_number', models.CharField(default=0, max_length=60, null=True)),
                ('phone_number', models.CharField(default='', max_length=250)),
                ('user_role', models.IntegerField(choices=[(1, 'MANAGER'), (2, 'WORKER')], default=2, null=True)),
